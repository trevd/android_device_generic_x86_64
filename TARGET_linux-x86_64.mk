...
TARGET_TOOLS_PREFIX := /usr/bin/x86_64-linux-gnu-
# You can set TARGET_TOOLS_PREFIX to get gcc from somewhere else


ifeq ($(strip $(TARGET_TOOLS_PREFIX)),)
TARGET_TOOLCHAIN_ROOT := prebuilts/gcc/$(HOST_PREBUILT_TAG)/x86_64/x86_64-linux-android-$(TARGET_GCC_VERSION)
...
TARGET_LIBGCC := $(shell $(TARGET_CC) -m64 -fPIC -print-file-name=libgcc.a)
endif
...
android_config_h := $(call select-android-config-h,target_linux-x86_64)
...
#
TARGET_GLOBAL_CFLAGS += -mstackrealign -msse3 -mfpmath=sse -m64
...
TARGET_GLOBAL_LDFLAGS += -m64 -fPIC
...
$(info "transform-o-to-shared-lib-inner")
	$(PRIVATE_CXX) \
	 -nostdlib -Wl,-soname,$(notdir $@) \
	 -shared -Bsymbolic -fPIC -nostdinc
	$(if $(filter true,$(PRIVATE_NO_CRT)),,$(PRIVATE_TARGET_CRTBEGIN_SO_O)) \
	$(PRIVATE_ALL_OBJECTS) \
	$(call normalize-target-libraries,$(PRIVATE_ALL_WHOLE_STATIC_LIBRARIES)) \
	$(call normalize-target-libraries,$(PRIVATE_ALL_STATIC_LIBRARIES)) \$(call normalize-target-libraries,$(PRIVATE_ALL_SHARED_LIBRARIES)) \
	-o $@ \
...
ifeq ($(TARGET_CPU_ABI),x86_64)
  ifneq (true-true-true-true,$(ARCH_X86_HAVE_MMX)-$(ARCH_X86_HAVE_SSE)-$(ARCH_X86_HAVE_SSE2)-$(ARCH_X86_HAVE_SSE3))
    $(info ERROR: Your x86_64 platform image is not compatible with the NDK x86 ABI)
